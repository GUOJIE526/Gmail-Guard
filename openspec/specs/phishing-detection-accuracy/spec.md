# phishing-detection-accuracy Specification

## Purpose
Define Gmail Guard's phishing-detection accuracy requirements for contextual local scoring, sender confidence, provider row extraction, optional Safe Browsing API URL reputation, boundary validation, and regression coverage.
## Requirements
