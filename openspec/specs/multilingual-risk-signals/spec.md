# multilingual-risk-signals Specification

## Purpose
Define browser-local multilingual phishing-risk wording signals for Gmail Guard so supported-language unread Gmail/Outlook rows can be evaluated without external translation, external AI, mailbox APIs, or broader network behavior.
## Requirements
