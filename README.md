...
The extension scans unread messages that are already visible on the current Gmail or Outlook page and highlights messages that may look suspicious because of sender/domain clues, brand impersonation wording, urgent account-verification language, payment/refund wording, prize or gift-card lures, or risky file wording.
...
它只讀取目前 Gmail 或 Outlook 頁面已經顯示在瀏覽器裡的內容，並在同一個郵件頁面上顯示提醒。
